...
export default function Formacion({ formacion, onClick }) {
	const elegirCarta = () => {
		onClick(formacion);
	};
	...
	return (
		<div className="formacion">
			<div
				className="bg-green-500 px-8 h-40 hover:bg-green-600 hover:-translate-y-4 transition-all cursor-pointer"
				onClick={elegirCarta}
			>
